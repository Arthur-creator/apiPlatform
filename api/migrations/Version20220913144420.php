 ...
 */
final class Version20220913144420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, answer_id INT DEFAULT NULL, joke_id INT DEFAULT NULL, message VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE joke (id INT NOT NULL, text VARCHAR(255) NOT NULL, answer VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
